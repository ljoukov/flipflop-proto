...
enum EmbedTypeProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [EmbedTypeProto] = [
    .embedTypeUnknown,
    .embedTypeAda002,
...
enum RecsTopicProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  case recsTopicChemistry // = 24
  case recsTopicAgriculture // = 25
  case UNRECOGNIZED(Int)
  ...
  init?(rawValue: Int) {
    ...
    case 24: self = .recsTopicChemistry
    case 25: self = .recsTopicAgriculture
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  var rawValue: Int {
    ...
    case .recsTopicChemistry: return 24
    case .recsTopicAgriculture: return 25
    case .UNRECOGNIZED(let i): return i
    }
  }

  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [RecsTopicProto] = [
    .recsTopicUndefined,
    .recsTopicArts,
    .recsTopicBusiness,
    .recsTopicCulture,
    ...
    .recsTopicBiology,
    .recsTopicChemistry,
    .recsTopicAgriculture,
  ]

}

/// Emotional impact on the user.
enum RecsImpactProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [RecsImpactProto] = [
    .recsImpactUnknown,
    .recsImpactLow,
    .recsImpactMedium,
    .recsImpactHigh,
...
enum RecsContentTypeProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [RecsContentTypeProto] = [
...
struct EmbedProto: @unchecked Sendable {
...
struct RecsScoredTopic: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct StoryRecsProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct StoriesRecsCacheProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension RecsTopicProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    24: .same(proto: "RECS_TOPIC_CHEMISTRY"),
    25: .same(proto: "RECS_TOPIC_AGRICULTURE"),
  ]
}
