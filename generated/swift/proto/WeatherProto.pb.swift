...
enum WeatherConditionProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [WeatherConditionProto] = [
...
struct WeatherProto: @unchecked Sendable {
...
struct WeatherCacheProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
