...
struct DeviceProto {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: DeviceProto.OneOf_Type, rhs: DeviceProto.OneOf_Type) -> Bool {
...
extension UserAgentProto: @unchecked Sendable {}
extension LocaleProto: @unchecked Sendable {}
extension LocationProto: @unchecked Sendable {}
extension DeviceProto: @unchecked Sendable {}
extension DeviceProto.OneOf_Type: @unchecked Sendable {}
extension IOSDeviceProto: @unchecked Sendable {}
