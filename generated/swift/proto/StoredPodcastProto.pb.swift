...
enum StoredPodcastSubscriptionTypeProto: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  case undefined // = 0
  case free // = 1
  case weekly // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [StoredPodcastSubscriptionTypeProto] = [
    .undefined,
    .free,
    .weekly,
    .monthly,
...
struct StoredPodcastQueryCompletionsProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct StoredPodcastQueryCompletionsSectionProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct StoredPodcastQueryCompletionProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct StoredPodcastUserProto: Sendable {
  ...
  var subscription: StoredPodcastSubscriptionProto {
    get {return _subscription ?? StoredPodcastSubscriptionProto()}
  ...
  fileprivate var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _subscription: StoredPodcastSubscriptionProto? = nil
}

struct StoredPodcastSubscriptionProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var subscriptionType: StoredPodcastSubscriptionTypeProto = .undefined

  var subscriptionPurchasedAt: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _subscriptionPurchasedAt ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_subscriptionPurchasedAt = newValue}
  }
  /// Returns true if `subscriptionPurchasedAt` has been explicitly set.
  var hasSubscriptionPurchasedAt: Bool {return self._subscriptionPurchasedAt != nil}
  /// Clears the value of `subscriptionPurchasedAt`. Subsequent reads from it will return its default value.
  mutating func clearSubscriptionPurchasedAt() {self._subscriptionPurchasedAt = nil}

  var subscriptionExpiresAt: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _subscriptionExpiresAt ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_subscriptionExpiresAt = newValue}
  }
  /// Returns true if `subscriptionExpiresAt` has been explicitly set.
  var hasSubscriptionExpiresAt: Bool {return self._subscriptionExpiresAt != nil}
  /// Clears the value of `subscriptionExpiresAt`. Subsequent reads from it will return its default value.
  mutating func clearSubscriptionExpiresAt() {self._subscriptionExpiresAt = nil}

  var appstoreState: StoredPodcastUserAppStoreStateProto {
    get {return _appstoreState ?? StoredPodcastUserAppStoreStateProto()}
    set {_appstoreState = newValue}
  }
  /// Returns true if `appstoreState` has been explicitly set.
  var hasAppstoreState: Bool {return self._appstoreState != nil}
  /// Clears the value of `appstoreState`. Subsequent reads from it will return its default value.
  mutating func clearAppstoreState() {self._appstoreState = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _subscriptionPurchasedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _subscriptionExpiresAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _appstoreState: StoredPodcastUserAppStoreStateProto? = nil
}

struct StoredPodcastUserAppStoreStateProto: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var latestTransactionID: String = String()

  var latestTransactionTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
    get {return _latestTransactionTimestamp ?? SwiftProtobuf.Google_Protobuf_Timestamp()}
    set {_latestTransactionTimestamp = newValue}
  }
  /// Returns true if `latestTransactionTimestamp` has been explicitly set.
  var hasLatestTransactionTimestamp: Bool {return self._latestTransactionTimestamp != nil}
  /// Clears the value of `latestTransactionTimestamp`. Subsequent reads from it will return its default value.
  mutating func clearLatestTransactionTimestamp() {self._latestTransactionTimestamp = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _latestTransactionTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}
...
extension StoredPodcastSubscriptionTypeProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "STORED_PODCAST_SUBSCRIPTION_TYPE_PROTO_UNDEFINED"),
    1: .same(proto: "STORED_PODCAST_SUBSCRIPTION_TYPE_PROTO_FREE"),
    2: .same(proto: "STORED_PODCAST_SUBSCRIPTION_TYPE_PROTO_WEEKLY"),
    3: .same(proto: "STORED_PODCAST_SUBSCRIPTION_TYPE_PROTO_MONTHLY"),
    4: .same(proto: "STORED_PODCAST_SUBSCRIPTION_TYPE_PROTO_ANNUAL"),
  ]
}
...
extension StoredPodcastSubscriptionProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "StoredPodcastSubscriptionProto"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "subscription_type"),
    2: .standard(proto: "subscription_purchased_at"),
    3: .standard(proto: "subscription_expires_at"),
    4: .standard(proto: "appstore_state"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._subscriptionPurchasedAt) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._subscriptionExpiresAt) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._appstoreState) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._subscriptionPurchasedAt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._subscriptionExpiresAt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try { if let v = self._appstoreState {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: StoredPodcastSubscriptionProto, rhs: StoredPodcastSubscriptionProto) -> Bool {
    if lhs.subscriptionType != rhs.subscriptionType {return false}
    if lhs._subscriptionPurchasedAt != rhs._subscriptionPurchasedAt {return false}
    if lhs._subscriptionExpiresAt != rhs._subscriptionExpiresAt {return false}
    if lhs._appstoreState != rhs._appstoreState {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension StoredPodcastUserAppStoreStateProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "StoredPodcastUserAppStoreStateProto"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "original_transaction_id"),
    2: .standard(proto: "latest_transaction_id"),
    3: .standard(proto: "latest_transaction_timestamp"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.originalTransactionID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.latestTransactionID) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._latestTransactionTimestamp) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.originalTransactionID.isEmpty {
      try visitor.visitSingularStringField(value: self.originalTransactionID, fieldNumber: 1)
    }
    if !self.latestTransactionID.isEmpty {
      try visitor.visitSingularStringField(value: self.latestTransactionID, fieldNumber: 2)
    }
    try { if let v = self._latestTransactionTimestamp {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: StoredPodcastUserAppStoreStateProto, rhs: StoredPodcastUserAppStoreStateProto) -> Bool {
    if lhs.originalTransactionID != rhs.originalTransactionID {return false}
    if lhs.latestTransactionID != rhs.latestTransactionID {return false}
    if lhs._latestTransactionTimestamp != rhs._latestTransactionTimestamp {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
