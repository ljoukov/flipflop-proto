...
enum LLMMessageRole: SwiftProtobuf.Enum {
...
extension LLMMessageRole: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [LLMMessageRole] = [
    .unknown,
    .system,
    .user,
    .assistant,
...
extension LLMMessageRole: @unchecked Sendable {}
extension LLMMessage: @unchecked Sendable {}
extension LLMUsage: @unchecked Sendable {}
extension LLMOutputProto: @unchecked Sendable {}
