 ...
 */
export interface DeletedStoryProto {
    /**
     * @generated from protobuf field: string id = 1;
     */
    id: string;
    ...
    createdBy: string;
    /**
     * @generated from protobuf field: google.protobuf.Timestamp deleted_at = 3;
     */
    deletedAt?: Timestamp;
}
/**
...
export enum CardTypeProto {
    ...
    CARD_TYPE_UNKNOWN = 0,
    /**
     * @generated from protobuf enum value: CARD_TYPE_STATIC = 1;
     */
    CARD_TYPE_STATIC = 1,
    /**
     * @generated from protobuf enum value: CARD_TYPE_TRUE_FALSE = 2;
     */
...
class GetStoriesRequestProto$Type extends MessageType<GetStoriesRequestProto> {
    ...
    create(value?: PartialMessage<GetStoriesRequestProto>): GetStoriesRequestProto {
        ...
        message.storiesUserDataUpdate = [];
        message.queuedStoryIds = [];
        if (value !== undefined)
...
class CardDataProto$Type extends MessageType<CardDataProto> {
    ...
    create(value?: PartialMessage<CardDataProto>): CardDataProto {
        ...
        message.title = "";
        message.body = "";
        message.isTrue = false;
        message.options = [];
        message.correctOptionIndex = 0;
        message.explanation = "";
        message.hashTags = [];
        if (value !== undefined)
...
// @generated message type with reflection information, may provide speed optimized methods
class DeletedStoryProto$Type extends MessageType<DeletedStoryProto> {
    constructor() {
        super("DeletedStoryProto", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "created_by", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "deleted_at", kind: "message", T: () => Timestamp }
        ]);
    }
    create(value?: PartialMessage<DeletedStoryProto>): DeletedStoryProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        message.createdBy = "";
        if (value !== undefined)
            reflectionMergePartial<DeletedStoryProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DeletedStoryProto): DeletedStoryProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* string created_by */ 2:
                    ...
                    break;
                case /* google.protobuf.Timestamp deleted_at */ 3:
    ...
    internalBinaryWrite(message: DeletedStoryProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string created_by = 2; */
...
/**
 * @generated MessageType for protobuf message DeletedStoryProto
 */
...
class TextSpanProto$Type extends MessageType<TextSpanProto> {
    ...
    create(value?: PartialMessage<TextSpanProto>): TextSpanProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.text = "";
        message.fontWeight = 0;
        message.fontStyle = 0;
        message.decoration = 0;
        if (value !== undefined)
...
class StyledTextProto$Type extends MessageType<StyledTextProto> {
    ...
    create(value?: PartialMessage<StyledTextProto>): StyledTextProto {
        ...
        message.fontName = 0;
        message.fontSize = 0;
        message.paddingStart = 0;
        message.paddingEnd = 0;
        message.align = 0;
