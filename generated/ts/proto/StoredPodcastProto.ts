...
export interface StoredPodcastProto {
    ...
    /**
     * @generated from protobuf field: StoredPodcastCompletionProto completion = 19;
     */
    completion?: StoredPodcastCompletionProto;
    /**
...
/**
 * @generated from protobuf message StoredPodcastSuggestionFromSectionInputProto
 */
export interface StoredPodcastSuggestionFromSectionInputProto {
    /**
...
/**
 * @generated from protobuf message StoredPodcastSuggestionFromRoutineStepInputProto
 */
export interface StoredPodcastSuggestionFromRoutineStepInputProto {
    /**
...
/**
 * @generated from protobuf message StoredPodcastCompletionProto
 */
export interface StoredPodcastCompletionProto {
    /**
...
export interface StoredPodcastStorySuggestionProto {
    /**
     * @generated from protobuf field: string suggestions_id = 5;
     */
    suggestionsId: string;
    /**
...
export interface StoredPodcastExerciseProto {
    ...
    /**
     * @generated from protobuf field: repeated StoredPodcastExerciseSectionProto sections = 6;
     */
    sections: StoredPodcastExerciseSectionProto[];
    /**
     * @generated from protobuf field: StoredPodcastStyleProto style = 5;
     */
    style?: StoredPodcastStyleProto;
...
export interface StoredPodcastExercisePlanProto {
    ...
    /**
     * @generated from protobuf field: repeated StoredPodcastExerciseSectionPlanProto sections = 8;
     */
    sections: StoredPodcastExerciseSectionPlanProto[];
}
/**
 * @generated from protobuf message StoredPodcastExerciseSectionPlanProto
 */
export interface StoredPodcastExerciseSectionPlanProto {
    /**
     * @generated from protobuf field: string label = 1;
     */
    label: string;
...
/**
 * @generated from protobuf message StoredPodcastOnboardingInputProto
 */
export interface StoredPodcastOnboardingInputProto {
    /**
    ...
    goalIds: string[];
    /**
     * @generated from protobuf field: repeated string learning_style_ids = 4;
     */
    learningStyleIds: string[];
    /**
     * @generated from protobuf field: repeated string interest_ids = 5;
     */
    interestIds: string[];
    /**
 ...
 */
export interface StoredPodcastAccessibilitySettingsProto {
    /**
     * @generated from protobuf field: StoredPodcastContentSizeCategoryProto content_size_category = 1;
     */
    contentSizeCategory: StoredPodcastContentSizeCategoryProto;
    /**
...
/**
 * @generated from protobuf enum StoredPodcastContentSizeCategoryProto
 */
export enum StoredPodcastContentSizeCategoryProto {
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_UNDEFINED = 0;
     */
    UNDEFINED = 0,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_X_SMALL = 1;
     */
    X_SMALL = 1,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_SMALL = 2;
     */
    SMALL = 2,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_MEDIUM = 3;
     */
    MEDIUM = 3,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_LARGE = 4;
     */
    LARGE = 4,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_X_LARGE = 5;
     */
    X_LARGE = 5,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_XX_LARGE = 6;
     */
    XX_LARGE = 6,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_XXX_LARGE = 7;
     */
    XXX_LARGE = 7,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_ACCESSIBILITY_MEDIUM = 8;
     */
    ACCESSIBILITY_MEDIUM = 8,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_ACCESSIBILITY_LARGE = 9;
     */
    ACCESSIBILITY_LARGE = 9,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_ACCESSIBILITY_X_LARGE = 10;
     */
    ACCESSIBILITY_X_LARGE = 10,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_ACCESSIBILITY_XX_LARGE = 11;
     */
    ACCESSIBILITY_XX_LARGE = 11,
    /**
     * @generated from protobuf enum value: STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_ACCESSIBILITY_XXX_LARGE = 12;
     */
...
class StoredPodcastProto$Type extends MessageType<StoredPodcastProto> {
    constructor() {
        super("StoredPodcastProto", [
            ...
            { no: 19, name: "completion", kind: "message", T: () => StoredPodcastCompletionProto },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* StoredPodcastExerciseProto exercise */ 18:
                    ...
                    break;
                case /* StoredPodcastCompletionProto completion */ 19:
                    message.completion = StoredPodcastCompletionProto.internalBinaryRead(reader, reader.uint32(), options, message.completion);
                    break;
    ...
    internalBinaryWrite(message: StoredPodcastProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.completion)
            StoredPodcastCompletionProto.internalBinaryWrite(message.completion, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* LogProto log = 101; */
        if (message.log)
...
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastSuggestionFromSectionInputProto$Type extends MessageType<StoredPodcastSuggestionFromSectionInputProto> {
    constructor() {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastSuggestionFromSectionInputProto): StoredPodcastSuggestionFromSectionInputProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: StoredPodcastSuggestionFromSectionInputProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message StoredPodcastSuggestionFromSectionInputProto
 */
export const StoredPodcastSuggestionFromSectionInputProto = new StoredPodcastSuggestionFromSectionInputProto$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastSuggestionFromRoutineStepInputProto$Type extends MessageType<StoredPodcastSuggestionFromRoutineStepInputProto> {
    constructor() {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastSuggestionFromRoutineStepInputProto): StoredPodcastSuggestionFromRoutineStepInputProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: StoredPodcastSuggestionFromRoutineStepInputProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string routine_id = 1; */
...
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastCompletionProto$Type extends MessageType<StoredPodcastCompletionProto> {
    constructor() {
        super("StoredPodcastCompletionProto", [
            { no: 1, name: "action", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "encouragement", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "emoji", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<StoredPodcastCompletionProto>): StoredPodcastCompletionProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.action = "";
        message.encouragement = "";
        message.emoji = "";
        if (value !== undefined)
            reflectionMergePartial<StoredPodcastCompletionProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastCompletionProto): StoredPodcastCompletionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: StoredPodcastCompletionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string action = 1; */
        if (message.action !== "")
...
/**
 * @generated MessageType for protobuf message StoredPodcastCompletionProto
 */
export const StoredPodcastCompletionProto = new StoredPodcastCompletionProto$Type();
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastSuggestionsProto$Type extends MessageType<StoredPodcastSuggestionsProto> {
    ...
    private binaryReadMap102(map: StoredPodcastSuggestionsProto["llmRequestIds"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof StoredPodcastSuggestionsProto["llmRequestIds"] | undefined, val: StoredPodcastSuggestionsProto["llmRequestIds"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field StoredPodcastSuggestionsProto.llm_request_ids");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class StoredPodcastStorySuggestionProto$Type extends MessageType<StoredPodcastStorySuggestionProto> {
    constructor() {
        super("StoredPodcastStorySuggestionProto", [
            { no: 5, name: "suggestions_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    internalBinaryWrite(message: StoredPodcastStorySuggestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.suggestionsId !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.suggestionsId);
...
class StoredPodcastExerciseProto$Type extends MessageType<StoredPodcastExerciseProto> {
    constructor() {
        super("StoredPodcastExerciseProto", [
            ...
            { no: 6, name: "sections", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => StoredPodcastExerciseSectionProto },
            { no: 5, name: "style", kind: "message", T: () => StoredPodcastStyleProto }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* StoredPodcastExercisePlanProto plan */ 1:
                    ...
                    break;
                case /* repeated StoredPodcastExerciseSectionProto sections */ 6:
                    message.sections.push(StoredPodcastExerciseSectionProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* StoredPodcastStyleProto style */ 5:
                    message.style = StoredPodcastStyleProto.internalBinaryRead(reader, reader.uint32(), options, message.style);
                    break;
    ...
    internalBinaryWrite(message: StoredPodcastExerciseProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.sections.length; i++)
            StoredPodcastExerciseSectionProto.internalBinaryWrite(message.sections[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        /* StoredPodcastStyleProto style = 5; */
        if (message.style)
            StoredPodcastStyleProto.internalBinaryWrite(message.style, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
class StoredPodcastExercisePlanProto$Type extends MessageType<StoredPodcastExercisePlanProto> {
    constructor() {
        super("StoredPodcastExercisePlanProto", [
            ...
            { no: 8, name: "sections", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => StoredPodcastExerciseSectionPlanProto }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string selected_category */ 4:
                    ...
                    break;
                case /* repeated StoredPodcastExerciseSectionPlanProto sections */ 8:
                    message.sections.push(StoredPodcastExerciseSectionPlanProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: StoredPodcastExercisePlanProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.sections.length; i++)
            StoredPodcastExerciseSectionPlanProto.internalBinaryWrite(message.sections[i], writer.tag(8, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastExerciseSectionPlanProto$Type extends MessageType<StoredPodcastExerciseSectionPlanProto> {
    constructor() {
        super("StoredPodcastExerciseSectionPlanProto", [
            { no: 1, name: "label", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "plan", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<StoredPodcastExerciseSectionPlanProto>): StoredPodcastExerciseSectionPlanProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.label = "";
        message.plan = "";
        if (value !== undefined)
            reflectionMergePartial<StoredPodcastExerciseSectionPlanProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastExerciseSectionPlanProto): StoredPodcastExerciseSectionPlanProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: StoredPodcastExerciseSectionPlanProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string label = 1; */
        if (message.label !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.label);
        /* string plan = 2; */
...
/**
 * @generated MessageType for protobuf message StoredPodcastExerciseSectionPlanProto
 */
export const StoredPodcastExerciseSectionPlanProto = new StoredPodcastExerciseSectionPlanProto$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class StoredPodcastOnboardingInputProto$Type extends MessageType<StoredPodcastOnboardingInputProto> {
    constructor() {
        super("StoredPodcastOnboardingInputProto", [
    ...
    create(value?: PartialMessage<StoredPodcastOnboardingInputProto>): StoredPodcastOnboardingInputProto {
        ...
        message.voiceId = "";
        if (value !== undefined)
            reflectionMergePartial<StoredPodcastOnboardingInputProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastOnboardingInputProto): StoredPodcastOnboardingInputProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* repeated string goal_ids */ 3:
                    ...
                    break;
                case /* repeated string learning_style_ids */ 4:
                    message.learningStyleIds.push(reader.string());
                    break;
                case /* repeated string interest_ids */ 5:
    ...
    internalBinaryWrite(message: StoredPodcastOnboardingInputProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.learningStyleIds.length; i++)
            writer.tag(4, WireType.LengthDelimited).string(message.learningStyleIds[i]);
        /* repeated string interest_ids = 5; */
        for (let i = 0; i < message.interestIds.length; i++)
            writer.tag(5, WireType.LengthDelimited).string(message.interestIds[i]);
        /* string voice_id = 6; */
        if (message.voiceId !== "")
...
class StoredPodcastAccessibilitySettingsProto$Type extends MessageType<StoredPodcastAccessibilitySettingsProto> {
    constructor() {
        super("StoredPodcastAccessibilitySettingsProto", [
            { no: 1, name: "content_size_category", kind: "enum", T: () => ["StoredPodcastContentSizeCategoryProto", StoredPodcastContentSizeCategoryProto, "STORED_PODCAST_CONTENT_SIZE_CATEGORY_PROTO_"] },
    ...
    create(value?: PartialMessage<StoredPodcastAccessibilitySettingsProto>): StoredPodcastAccessibilitySettingsProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        ...
        if (value !== undefined)
            reflectionMergePartial<StoredPodcastAccessibilitySettingsProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StoredPodcastAccessibilitySettingsProto): StoredPodcastAccessibilitySettingsProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* StoredPodcastContentSizeCategoryProto content_size_category */ 1:
    ...
    internalBinaryWrite(message: StoredPodcastAccessibilitySettingsProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message StoredPodcastAccessibilitySettingsProto
 */
